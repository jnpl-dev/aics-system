                        ...
                        <div>
                            ...
                            <div class="fi-ta-selection-indicator-actions-ctn">
                                @if (! $selectsGroupsOnly)
                                    ...
                                    >
                                        {{ trans_choice('filament-tables::table.selection_indicator.actions.select_all.label', $allSelectableRecordsCount, ['count' => extension_loaded('intl') ? \Illuminate\Support\Number::format($allSelectableRecordsCount, locale: app()->getLocale()) : number_format($allSelectableRecordsCount)]) }}
                                    </x-filament::link>
                                @endif
