@php
    ...
    $isPendingReviewActionable = in_array((string) $record->status, ['submitted', 'under_review'], true);
...
<x-filament-panels::page>
    <div class="mx-auto w-full max-w-7xl space-y-4">
        <div class="grid grid-cols-1 gap-4 xl:grid-cols-4">
            <div class="xl:col-span-3 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900/40">
                <section class="border-b border-gray-200 p-6 dark:border-gray-800">
                    <h3 class="text-xs font-bold uppercase tracking-[0.2em] text-emerald-700 dark:text-emerald-300">Application Profile</h3>
                    <p class="mt-1 text-sm text-gray-500">All information below is read-only for review.</p>
                ...
                <section class="border-b border-gray-200 p-6 dark:border-gray-800">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Complete applicant and beneficiary details.</p>
        ...
        <div class="flex flex-wrap items-center justify-start gap-2">
            ...
            @if ($isPendingReviewActionable)
                <button type="button" wire:click="mountAction('returnAndRequestResubmission')" class="inline-flex rounded-lg bg-amber-500 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-400">Return &amp; Request Resubmission</button>
                <button type="button" wire:click="mountAction('forwardToMswdo')" class="inline-flex rounded-lg bg-emerald-700 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-600">Forward to MSWDO</button>
            @endif
        </div>
